...
var root:any = freeGlobal || Function("return this")();
 ...
 */
function baseTimes(n:any, iteratee:any) {
  let index = -1;
...
function baseValues(object:any, props:any) {
  return arrayMap(props, (key:any) => object[key]);
}
 ...
 */
function getValue(object: any, key:any) {
 ...
 * @returns {Array} Returns the converted array.
 */
function unicodeToArray(string: any) {
...
const WeakMap:any = getNative(root, "WeakMap");
 ...
 */
function arrayLikeKeys(value: any, inherited:any):Function {
 ...
 */
function getNative(object: any, key:any):Function {
