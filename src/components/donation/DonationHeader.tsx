  ...
  return (
    <Grid container component="main" className={classes.root}>
      <Grid item xs={12} sm={8} md={5} className={classes.info}>
        <p>Help us do more</p>
        <p>
          We’ll get right to the point. With the coronavirus (COVID-19) creating
          mass school closings, demand for DIY Foundation has spiked. Please
          help us meet this demand. A gift of $10 monthly would make a big
          difference. We’re a nonprofit that relies on support from people like
          you. Thank you!
        </p>
      </Grid>
        ...
        <div>
          ...
          <FormControl>
            ...
            <div>
              <FormControlLabel
                control={
                  <Checkbox value="remember" className={classes.checkedIcon} />
                }
...
export default withWidth()(
  withStyles(styles, { withTheme: true })(DonationHeader)
);
